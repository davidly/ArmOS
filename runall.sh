...
for arg in tcmp t e printint sieve simple tmuldiv tpi ts tarray tbits trw trw2 tmmap tstr \
           ...
           mm tao pis ttypes nantst sleeptm tatomic lenum tregex trename nqueens fopentst termiosf taux;
do
    echo $arg
...
do
    ...
    $_armoscmd c_tests/bin$optflag/targs a bb ccc dddd >>$outputfile
done    
